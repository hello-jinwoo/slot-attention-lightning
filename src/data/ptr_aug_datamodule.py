...
from src.data.components.ptr_aug import PTRAug


class PTRAugDataModule(LightningDataModule):
    """LightningDataModule for PTR with DataAugmentation.
